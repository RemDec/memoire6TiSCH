...
\vspace{0.1cm}        
    ...
    \frame{
        \frametitle{Impact de sécurité sur la joining phase}
                \begin{figure}
        \includegraphics[width=0.65\linewidth]{{results/secjoin/boxesTimeConvergence20}}
    ...
    \frame{
        ...
        \end{enumerate}
        \vspace{0.5cm}        
        Expérimentations : réseau de 30 noeuds, 10 runs et résultats agrégés
    }
    ...
    \frame{
        ...
        \caption{\footnotesize [EBs] Charges consommées aux $\neq$ étapes tous noeuds et runs confondus}
        \end{figure}
    }
    \frame{
        \begin{figure}
        \includegraphics[width=0.75\linewidth]{{results/NPEB/phase_charges}}
        \caption{\footnotesize [NPEBs] Charges consommées aux $\neq$ étapes tous noeuds et runs confondus}
        \end{figure}
    }

...
\State $score \leftarrow score - $ \textit{NPtable}$[neighbor][joinMetric]$
\If{\textit{neighbor} est Root de la topologie \textbf{ou} prefered parent de \textit{node}}
...
\subsubsection{Décision de continuité du processus itératif NPEB}
...
\subsubsection{Cell Rx après une annonce NPEB}
